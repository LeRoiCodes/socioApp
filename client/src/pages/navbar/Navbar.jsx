...
function Navbar() {
  ...
  return (
    <FlexBetween padding="1rem 6%" backgroundColor={alt} >
      ...
      {isNotMobileScreen ? (
        <FlexBetween gap={"2rem"}>
          ...
          <FormControl variant="standard" value={fullName}>
            <Select value={fullName} sx={{backgroundColor: neutralLight, width: "150px", borderRadius: "0.25rem", p: "0.25rem 1rem", "& .MuiSvgIcon-root": {pr: "0.25rem", width: "3rem"}, "& .MuiSelect-select:focus" : { backgroundColor: neutralLight
            }
            }}
            input={<InputBase />}
            >
      ...
      {/* Mobile Nav */}
      {
        !isNotMobileScreen && isMobileMenu && (
          <Box position={"fixed"} right={"0"} bottom={"0"} height="100%" zIndex={"10"} maxWidth={"500px"} minWidth={"300px"} backgroundColor={background} >
            ...
            <FlexBetween display={"flex"} gap={"3rem"} flexDirection={"column"} justifyContent={"center"} alignItems={"center"}>
